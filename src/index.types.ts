...
type HttpOptions = 
    | [ImpulseURL | RequestOptionsWithoutMethod] 
    | [ImpulseURL, RequestOptionsWithoutUrlAndMethod]
    | [RequestOptionsWithoutMethod]

type HttpDataOptions = 
    | [ImpulseURL]
    | [ImpulseURL, RequestDataBody]
    | [ImpulseURL, RequestDataBody, RequestOptionsWithoutUrlAndMethod]
